...
1. The second way to create a column is by clicking on 'AI assistant,' and describe your task, and the AI assistant will set up everything for you. E.g.: "find the ceo of the company." This is recommened only to create AI columns and formulas.

![](/images/add_column_with_ai_assistant.png)
