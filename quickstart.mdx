...
* **Start From Scratch:** Create your own custom blank table. The default column provided is company name and you can modify it according to your needs.
...
* **Table View:** Visualize and manage your data in a structured table format. You can customize each column by clicking on the headers to access:
  ...
  * **Run AI Column:** Run the AI column by clicking on the play icon to extract the data.
...
* **Add data:** You can import data directly into your table by clicking on the ‘add data,’ button.

* **AI assistant:** Get assistance from our AI assistant for suggestions, table modifications, lead enrichment, insights, and data-related clarifications.
