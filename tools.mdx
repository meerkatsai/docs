...
2. Click on drop down icon to open colum edit options

3. Click on 'Tools' and search for 'meerkats agent'

4. Click on the tool and save
...
2. Enter your prompt in the prompt box, use @ to refer to previous column
   ...
   E.g.: Find the ceo of @companyname
