...
2. Enter your prompt in the prompt box, use @ to refer to previous column




   E.g.: Scrape @domain and get the hero message
...
2. Enter your prompt in the prompt box, use @ to refer to previous column
   ...
   E.g.: Extract title, link and snippet from @serp
...
2. Enter your prompt in the prompt box, use @ to refer to previous column
   ...
   E.g.: write a presonalzied message uisng data from @ceoname, @webdata, @linkedin data
...
2. Enter your prompt in the prompt box, use @ to refer to previous column
   ...
   E.g.: Find email of @ceoname of @domain
